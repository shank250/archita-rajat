      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-lg bg-white rounded-t-3xl sm:rounded-3xl border border-[#EBE6DC] shadow-google-elevated p-7 text-[#202124] z-10"
          >
            {/* Close Button */}
            <button
              onClick={onClose}
            ...
            <div className="flex items-center gap-3 mb-5">
              <div className="w-10 h-10 rounded-2xl bg-[#FCE8E6] text-[#EA4335] flex items-center justify-center shadow-sm">
            ...
            <div className="my-4 rounded-2xl border border-[#EBE6DC] bg-[#FDFBF7] p-5">
              <p className="font-serif text-lg font-bold text-[#202124]">
                {couple.ceremonyTitle}
              </p>
              <p className="text-xs font-sans text-[#C5221F] font-bold mt-1">
                📅 {event.displayDate}
              </p>
              <p className="text-xs font-sans text-[#3C4043] mt-1">
                ⏰ 6:30 PM IST onwards
              </p>
              <p className="text-xs font-sans text-[#5F6368] mt-0.5">
            ...
            <div className="space-y-3 mt-6">
              ...
              <button
                ...
                className="flex items-center justify-between w-full px-6 py-3.5 rounded-full bg-[#F1F3F4] hover:bg-[#E8EAED] border border-[#DDD8CE] text-[#3C4043] font-sans text-sm font-bold transition-all cursor-pointer"
              >
                <div className="flex items-center gap-2.5">
                  <Download className="w-4 h-4 text-[#5F6368]" />
                  <span>Download .ICS (Apple & Outlook)</span>
                </div>
                <span className="text-[10px] font-sans uppercase text-[#5F6368] font-bold">
                  .ics
                </span>
              </button>
            </div>
