      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-lg bg-white rounded-t-3xl sm:rounded-3xl border border-neutral-200 shadow-xl p-7 text-neutral-900 z-10 max-h-[90vh] overflow-y-auto"
          >
            {/* Close Button */}
            <button
              onClick={onClose}
            ...
            <div className="my-4 rounded-2xl border border-neutral-200 bg-[#FAFAFA] p-5">
              ...
              <p className="text-xs font-sans text-[#881337] font-semibold mt-0.5">
                {event.venue.tagline}
              </p>
            ...
            <div className="space-y-3 mt-6">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-between w-full px-6 py-3.5 rounded-full bg-neutral-100 hover:bg-neutral-200 border border-neutral-200 text-neutral-800 font-sans text-sm font-semibold transition-all"
              >
                <div className="flex items-center gap-2.5">
